...
const RealContact = () => {
    ...
    return (
        <section style={{ margin: '0 auto', marginTop: '6rem', marginBottom: '4rem' }} className="w-full min-h-screen  bg-white py-16 px-4 flex flex-col items-center justify-center gap-12">
