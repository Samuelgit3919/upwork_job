...
const Work = () => {
    ...
    return (
        <div style={{ margin: '0 auto', marginTop: '6rem', padding: '0 1rem' }} className="min-h-screen max-w-[1220px] text-center py-10 px-4 md:px-8 lg:px-16 flex flex-col">
            {/* Back to Home Link */}
            <Link data-aos="fade-up" to="/" style={{ marginTop: '0rem', marginBottom: '2rem' }} className='text-[#DB7F97] text-[18px] text-center flex justify-center font-outfit font-normal items-center hover:text-pink-300 transition-colors'>
            ...
            <div style={{ margin: '0 auto' }} className="text-center  flex flex-col gap-6 items-center mb-12">
                <h1 data-aos="fade-up" className="text-[24px] font-normal font-outfit text-center mb-4 text-[#000000]">Work</h1>
                <h2 data-aos="fade-up" className="text-[24px] font-normal font-outfit text-[#666666]  mb-4">Let's Create Something Cool ⚡</h2>
                <p data-aos="fade-up" className="text-[#666666] font-normal font-outfit text-center text-[23px]">
            ...
            <div style={{ marginTop: "3rem" }}>
                ...
                <h2 data-aos="fade-up" style={{ margin: '2rem 0' }} className="text-[24px] font-[400] mt-4 md:mt-16 mb-6 md:mb-8 font-Nunito text-center">
            ...
            <div style={{ margin: '0 auto', marginTop: '4rem' }} className='flex text-center items-center flex-col gap-6'>
                <div className="animate-fadeInUp">
                    <h3 data-aos="fade-up" className="text-[23px] text-[#000000] font-normal font-outfit">Let's Create Something Extraordinary ⚡</h3>
                </div>
                <div className="animate-fadeInUp w-full">
                    <p data-aos="fade-up" className="text-[18px] font-outfit text-[#000000]">
