...
import super4 from '../../assets/reSuper (2).png';
...
const SuperFlyDetail = () => {
    return (
        <div style={{ margin: '0 auto', marginTop: '6rem', padding: '0 1rem' }} className="container font-[outfit] max-w-[1090px] mx-auto mt-32 px-4 flex flex-col items-center">
            {/* Back to Home Link */}
            <Link data-aos="fade-up" to="/work" style={{ marginTop: '0rem', marginBottom: '2rem' }} className='text-[#DB7F97] text-[18px] text-center flex justify-center items-center hover:text-pink-300 transition-colors'>
                <ArrowLeftIcon className='w-8 h-4' />
                Back to work
            </Link>

            {/* Main Heading */}
            <div data-aos="fade-up" style={{ margin: '0 auto' }} className="text-center flex flex-col gap-8 mb-12">
            ...
            {/* Context Section */}
            <div data-aos="fade-up" className="w-full max-w-5xl text-left py-10">
            ...
            {/* Redesign Section */}
            <div data-aos="fade-up" style={{ margin: '4rem 0' }} className="w-full max-w-5xl text-left mt-16">
                <h5 className="text-[20px] md:text-xl mb-4">Redesign:</h5>
                <p className="text-[20px]  text-[#000000] leading-relaxed ">
                    The brand was focusing on a 1970’s disco approach. I was  <b>in charge of creating the library,
                        the design system, and designing the site.</b> Designs were provided for desktop and mobile and
