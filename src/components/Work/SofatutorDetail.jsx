...
import Finalui from "../../assets/finalUi.jpg"
import originalInfo from "../../assets/originalInfoPage.png"
import mobileInfo from "../../assets/mobileInfoPage.jpg"
        ...
        <div style={{ margin: '0 auto', marginTop: '6rem', padding: '0 1rem' }} className="container font-outfit max-w-[1090px] mx-auto mt-32 px-4 flex flex-col items-center">
            ...
            <div className="w-full font-outfit max-w-5xl text-left py-10">
                <div className="flex flex-col gap-8">
                    <div>
                        <h5 className="text-[24px] font-[400]">Context:</h5>
                        <p className="text-[24px] font-[400] text-gray-700 leading-relaxed">
                ...
                <div style={{ margin: "2rem auto" }} className="mt-6 gap-8 flex flex-col justify-center items-center">
                    ...
                    <div className="w-full flex flex-col md:flex-row justify-center items-center gap-6">
                        <div className="w-full md:w-1/2 flex flex-col justify-center items-start">
                            <h5 className="text-[20px] font-[400]">User Journey:</h5>
                            <p className="text-[20px] font-[400] text-gray-700 leading-relaxed">
            ...
            <div className='flex flex-col lg:flex-row items-start justify-center gap-8 mt-8 w-full max-w-6xl flex-wrap'>
                <div className="flex flex-col sm:flex-row justify-center items-start gap-6 w-full">
                    <img src={originalInfo} alt="Low Fi UI 1" className="w-[307px] max-h-[412px] rounded-md" />
                    <div className="w-[246px] h-[850px] overflow-hidden border-[5px] border-[#DB7FA4] rounded-[8px] shadow-md">
                        <img src={mobileInfo} alt="Responsive 2" className="w-full h-auto" />
                    </div>
                    <div className="h-[850px]  relative border-[5px] border-[#DB7FA4] rounded-[8px] shadow-md">
                        <div className="h-full overflow-hidden">
                            <img src={Finalui} alt="Responsive 1" className="w-[503px] h-auto" />
                        </div>
                        <Link
                            to="https://www.sofatutor.com/erfahrungen"
                            target="_blank"
                            className="absolute top-124 transform translate-x-86"
                        >
