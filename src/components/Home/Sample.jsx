...
const Sample = () => {
    ...
    return (
        <section style={{ padding: '0 1rem', margin: '  0' }} className="w-full  sm:h-[80vh] px-4 md:px-6 py-10 md:py-16 flex flex-col items-center bg-white">
            {/* NDA Notice */}
            <div style={{ marginBottom: '4rem' }} data-aos="fade-up" className="max-w-3xl mx-auto  md:mb-12 px-2 md:px-4 mt-4 md:mt-4">
